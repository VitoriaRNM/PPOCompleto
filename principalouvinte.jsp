...
<ul id="nav">
    ...
    <li><a href="http://localhost:8080/ppo/Editor.jsp">Adicionar Simbolo</a></li>
    <li><a href="http://localhost:8080/ppo/Editor.jsp">Elaborar Texto</a>
...
<ul id="nav">
    ...
    <li><a href="pricipalouvinte.html"> <i class="material-icons"style=" height:100%;">home</i>Inicio</a></li>
      <li><a href="http://localhost:8080/ppo/Editor.jsp"><i class="material-icons"style=" height:100%;">add</i>Adicionar Simbolo</a></li>
    <li><a href="http://localhost:8080/ppo/Editor.jsp"> <i class="material-icons"style=" height:100%;">app_registration</i>Elaborar Texto</a>
