...
<form method="post" id="formpost"  enctype="multipart/form-data" action="http://localhost:8080/ppo/ContaConta" >
...
<button onclick="mostrar('seuformulario')">mão1</button>
    <form id="seuformulario" style="display: none;" >
...
<button onclick="mostrar('seuformulario2')">mão2</button>
       <form id="seuformulario2" style="display: none;" >
  ...
  <div class="mdl-toolbar" class="mdl-button mdl-js-button mdl-button--icon"  title="mao" style="display:inline-block">
    <button onclick="mostrar('seuformulario3')" >mão3</button>
       <form id="seuformulario3" style="display: none;" >
  ...
  <div class="mdl-toolbar" class="mdl-button mdl-js-button mdl-button--icon"  title="mao" style="display:inline-block">
    ...
    <button onclick="mostrar('seuformulario4')">mão4</button>
       ...
       <form id="seuformulario4" style="display: none;" >
  ...
  <div class="mdl-toolbar" class="mdl-button mdl-js-button mdl-button--icon"  title="mao" style="display:inline-block">
    ...
    <button onclick="mostrar('seuformulario5')" >mão5</button>
       ...
       <form id="seuformulario5" style="display: none;" >
  ...
  <div class="mdl-toolbar" class="mdl-button mdl-js-button mdl-button--icon"  title="mao" style="display:inline-block">
    ...
    <button onclick="mostrar('seuformulario6')">mão6</button>
       ...
       <form id="seuformulario6" style="display: none;">
  ...
  <div class="mdl-toolbar" class="mdl-button mdl-js-button mdl-button--icon"  title="mao" style="display:inline-block">
    ...
    <button onclick="mostrar('seuformulario7')">mão7</button>
       ...
       <form id="seuformulario7" style="display: none;">
  ...
  <div class="mdl-toolbar" class="mdl-button mdl-js-button mdl-button--icon"  title="mao" style="display:inline-block">
    ...
    <button onclick="mostrar('seuformulario8')">mão8</button>
       ...
       <form id="seuformulario8" style="display: none;">
  ...
  <div class="mdl-toolbar" class="mdl-button mdl-js-button mdl-button--icon"  title="mao" style="display:inline-block">
    ...
    <button onclick="mostrar('seuformulario9')">mão9</button>
       ...
       <form id="seuformulario9" style="display: none;">
  ...
  <div class="mdl-toolbar" class="mdl-button mdl-js-button mdl-button--icon"  title="mao" style="display:inline-block">
    ...
    <button onclick="mostrar('seuformulario10')">mão10</button>
       ...
       <form id="seuformulario10" style="display: none;">
  ...
  <div class="mdl-toolbar" class="mdl-button mdl-js-button mdl-button--icon"  title="mao" style="display:inline-block">
    ...
    <button onclick="mostrar('seuformulariot')">Toques</button>
       ...
       <form id="seuformulariot" style="display: none;">
  ...
  <div class="mdl-toolbar" class="mdl-button mdl-js-button mdl-button--icon"  title="mao" style="display:inline-block">
    ...
    <button onclick="mostrar('seuformularioc1')">Carinhas</button>
       ...
       <form id="seuformularioc1" style="display: none;">
...
reader.onloadend=function(){
	...
	$.ajax({
		method: "POST",
		url: "http://localhost:8080/ppo/ContaConta",
		data: {fileUpload : reader.result,nome: $("#nome").val()}
	}).done(function(){
		alert("Sucesso ");
